/* empty css                      */import{a as m,b as h}from"./assets/vendor-0363fca5.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))t(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&t(l)}).observe(document,{childList:!0,subtree:!0});function s(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerpolicy&&(n.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?n.credentials="include":o.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function t(o){if(o.ep)return;o.ep=!0;const n=s(o);fetch(o.href,n)}})();const _="https://food-boutique.b.goit.study/api",d=m.create({baseURL:`${_}/products`}),b=m.create({baseURL:`${_}/subscription`});m.create({baseURL:`${_}/orders`});const w=function(){let e;const r=h.create(`
    <div class="modal">
...
`,{onShow:t=>{window.addEventListener("keydown",s),e=t.element().querySelector(".footer__modal-close"),e.addEventListener("click",()=>t.close()),document.body.classList.add("modal-open")},onClose:()=>{e.removeEventListener("click",()=>r.close()),window.removeEventListener("keydown",s),document.body.classList.remove("modal-open")}});r.show();function s(t){t.code==="Escape"&&r.close()}},c={productsFilters:document.querySelector(".products__filters-input"),productsFiltersSelect:document.querySelector(".products__filters-select"),productsCards:document.querySelector(".cards"),btnSubmit:document.querySelector(".products__filters-form"),input:document.querySelector(".products__filters-input"),discountCards:document.querySelector(".discount__list"),cardWrapper:document.querySelector(".cart__wrapper")};let k={keyword:null,category:null,page:1,limit:6},u=JSON.stringify(k);const E=document.querySelector(".footer__form");E.addEventListener("submit",$);function $(e){e.preventDefault();const{value:r}=e.currentTarget.elements.email;C(r),e.target.reset()}async function C(e){try{(await b({method:"POST",data:{email:e}})).statusText==="Created"&&w()}catch({response:r}){r.statusText==="Conflict"&&L()}}function f(e){return e=e.replace("_&_"," / "),e=e.replace("_"," "),e}function g(e){return e=e.replace(/ /g,"_"),e=e.replace(/\//g,encodeURIComponent("&")),e}function v(){const e=c.productsFiltersSelect.options[c.productsFiltersSelect.selectedIndex];let r=localStorage.getItem("filter"),s=r?JSON.parse(r):{};const t=e.textContent!=="Show all"?e.textContent:null;s.category=t,localStorage.setItem("filter",JSON.stringify(s)),s.category===null&&s.keyword===null?(localStorage.setItem("filter",u),s.category=null,p().then(o=>{let n=i(o.results);c.productsCards.innerHTML=n}).catch):s.category!==null&&s.keyword===null?I(g(s.category),s.page,s.limit).then(o=>{let n=i(o.results);c.productsCards.innerHTML=n,console.log(o)}).catch(o=>{console.log(o)}):s.category===null&&s.keyword!==null?(localStorage.setItem("filter",JSON.stringify(s)),p().then(o=>{let n=i(o.results);localStorage.setItem("filter",u),c.productsFilters.value="",c.productsCards.innerHTML=n}).catch,localStorage.setItem("filter",data1),c.productsFilters.value=""):s.category!==null&&s.keyword!==null&&S(s.keyword,g(s.category),s.page,s.limit).then(o=>{let n=i(o.results);c.productsCards.innerHTML=n,console.log(o)}).catch(o=>{console.console.log()})}function T(e){e.preventDefault();const r=c.input.value;let s=localStorage.getItem("filter"),t=s?JSON.parse(s):{};const o=r!==""?r:null;t.keyword=o,localStorage.setItem("filter",JSON.stringify(t));let n=u;t.keyword===null?p().then(l=>{let a=i(l.results);localStorage.setItem("filter",n),c.productsCards.innerHTML=a}).catch(l=>{console.error(l)}):t.keyword!==null&&t.category===null?y(t.keyword,t.page,t.limit).then(l=>{let a=i(l.results);c.productsCards.innerHTML=a}).catch(l=>{console.error(l)}):t.keyword!==null&&t.category!==null?S(t.keyword,t.category,t.page,t.limit).then(l=>{let a=i(l.results);c.productsCards.innerHTML=a}).catch(l=>{console.error(l)}):t.keyword!==null&&t.category===null&&(localStorage.setItem("filter",JSON.stringify(t)),y(t.keyword,t.page,t.limit).then(l=>{let a=i(l.results);c.productsCards.innerHTML=a}).catch(l=>{console.error(l)}))}function i(e){return e.map(({_id:r,name:s,img:t,category:o,price:n,size:l,popularity:a})=>`
                ...
                </li>`).join("")}function x(e){return e.map(({_id:r,name:s,img:t,price:o})=>`<li class="discount__item" data-id="${r}">
