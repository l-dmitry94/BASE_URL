import{a as f}from"./vendor-15eb2490.js";(function(){const c=document.createElement("link").relList;if(c&&c.supports&&c.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function e(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerpolicy&&(r.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?r.credentials="include":a.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(a){if(a.ep)return;a.ep=!0;const r=e(a);fetch(a.href,r)}})();const b={CART_KEY:"cart"},l={productsFilters:document.querySelector(".products__filters-input"),productsFiltersSelect:document.querySelector(".products__filters-select"),productsCards:document.querySelector(".cards"),btnSubmit:document.querySelector(".products__filters-form"),input:document.querySelector(".products__filters-input"),discountCards:document.querySelector(".discount__list"),popularCards:document.querySelector(".popular__list"),cardWrapper:document.querySelector(".cart__wrapper"),pagination:document.querySelector(".tui-pagination"),cartProducts:document.querySelector(".cart__products"),cartQuantity:document.querySelectorAll(".cart-quantity"),deleteAllProductsFromCart:document.querySelector(".cart__delete-button"),totalPrice:document.querySelector("#cart__total"),sendForm:document.querySelector(".checkout__field")};let k={keyword:null,category:null,page:1,limit:6},p=JSON.stringify(k);const P=document.querySelector(".footer__form");function R(t){return l.cartQuantity.forEach(c=>c.textContent=t.length)}const g="https://food-boutique.b.goit.study/api",u=f.create({baseURL:`${g}/products`}),x=f.create({baseURL:`${g}/subscription`}),M=f.create({baseURL:`${g}/orders`});function O(t,c){localStorage.setItem(c,JSON.stringify(t))}function w(t){try{const c=localStorage.getItem(t);return c?JSON.parse(c):[]}catch(c){console.log(c.message)}}const i="/BASE_URL/assets/icons-30be3c26.svg";async function C(){const t=w(b.CART_KEY);t&&t.forEach(({_id:c})=>{const e=document.querySelector(`[data-id="${c}"]`);if(e){const s=e.querySelector(".cards__button");s&&(s.innerHTML=`<svg class="icon-checked"><use href="${i}#icon-check"></use></svg>`)}})}async function F(){return(await u({method:"GET",url:"/categories"})).data}async function m(){const t=await u({method:"GET"});return C(),t.data}async function U(t,c){const e=await u({method:"GET",url:`?page=${t}&limit=${c}`});return console.log(e.data),e.data}async function y(t,c,e){return(await u({method:"GET",url:`?keyword=${t}&page=${c}&limit=${e}`})).data}async function S(t,c,e,s){return(await u({method:"GET",url:`?keyword=${t}&category=${c}&page=${e}&limit=${s}`})).data}async function E(t,c,e){return(await u({method:"GET",url:`?category=${t}&page=${c}&limit=${e}`})).data}async function N(t){return(await u({method:"GET",url:`/${t}`})).data}async function G(){return(await u({method:"GET",url:"/discount"})).data}async function B(){return(await u({method:"GET",url:"/popular"})).data}function _(t){return t=t.replace("_&_"," / "),t=t.replace("_"," "),t}function h(t){return t=t.replace(/ /g,"_"),t=t.replace(/\//g,encodeURIComponent("&")),t}function D(){const t=l.productsFiltersSelect.options[l.productsFiltersSelect.selectedIndex];let c=localStorage.getItem("filter"),e=c?JSON.parse(c):{};const s=t.textContent!=="Show all"?t.textContent:null;e.category=s,localStorage.setItem("filter",JSON.stringify(e)),e.category===null&&e.keyword===null?(localStorage.setItem("filter",p),e.category=null,m().then(a=>{let r=d(a.results);l.productsCards.innerHTML=r}).catch):e.category!==null&&e.keyword===null?E(h(e.category),e.page,e.limit).then(a=>{let r=d(a.results);l.productsCards.innerHTML=r,console.log(a)}).catch(a=>{console.log(a)}):e.category===null&&e.keyword!==null?(localStorage.setItem("filter",JSON.stringify(e)),m().then(a=>{let r=d(a.results);localStorage.setItem("filter",p),l.productsFilters.value="",l.productsCards.innerHTML=r}).catch,localStorage.setItem("filter",data1),l.productsFilters.value=""):e.category!==null&&e.keyword!==null&&S(e.keyword,h(e.category),e.page,e.limit).then(a=>{let r=d(a.results);l.productsCards.innerHTML=r,console.log(a)}).catch(a=>{console.console.log()})}function H(t){t.preventDefault();const c=l.input.value;let e=localStorage.getItem("filter"),s=e?JSON.parse(e):{};const a=c!==""?c:null;s.keyword=a,localStorage.setItem("filter",JSON.stringify(s));let r=p;s.keyword===null?m().then(o=>{let n=d(o.results);localStorage.setItem("filter",r),l.productsCards.innerHTML=n}).catch(o=>{console.error(o)}):s.keyword!==null&&s.category===null?y(s.keyword,s.page,s.limit).then(o=>{let n=d(o.results);l.productsCards.innerHTML=n}).catch(o=>{console.error(o)}):s.keyword!==null&&s.category!==null?S(s.keyword,s.category,s.page,s.limit).then(o=>{let n=d(o.results);l.productsCards.innerHTML=n}).catch(o=>{console.error(o)}):s.keyword!==null&&s.category===null&&(localStorage.setItem("filter",JSON.stringify(s)),y(s.keyword,s.page,s.limit).then(o=>{let n=d(o.results);l.productsCards.innerHTML=n}).catch(o=>{console.error(o)}))}const v="/BASE_URL/assets/empty-mobile-88cc64a6.png",L="/BASE_URL/assets/empty-mobile@2x-9530797e.png",q="/BASE_URL/assets/empty-tab-8d1fa0db.png",T="/BASE_URL/assets/empty-tab@2x-36112229.png",$="/BASE_URL/assets/checkout-image-046578b5.png",A="/BASE_URL/assets/checkout-image-046578b5.png";function d(t){return t.map(({_id:c,name:e,img:s,category:a,price:r,size:o,popularity:n})=>`
...
`}function Q(t){return`
    ...
    `}export{U as A,Y as a,K as b,b as c,M as d,Q as e,i as f,w as g,P as h,x as i,G as j,j as k,C as l,B as m,J as n,N as o,z as p,R as q,l as r,O as s,F as t,_ as u,p as v,m as w,d as x,D as y,H as z};
//# sourceMappingURL=markup-d2bd6de0.js.map
