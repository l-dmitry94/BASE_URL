import{a as v,b as C}from"./vendor-4f126749.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const c of o)if(c.type==="childList")for(const r of c.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const c={};return o.integrity&&(c.integrity=o.integrity),o.referrerpolicy&&(c.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?c.credentials="include":o.crossorigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function a(o){if(o.ep)return;o.ep=!0;const c=t(o);fetch(o.href,c)}})();const q={CART_KEY:"cart"},l={productsFilters:document.querySelector(".products__filters-input"),productsFiltersSelect:document.querySelector(".products__filters-select"),productsCards:document.querySelector(".cards"),btnSubmit:document.querySelector(".products__filters-form"),input:document.querySelector(".products__filters-input"),discountCards:document.querySelector(".discount__list"),popularCards:document.querySelector(".popular__list"),cardWrapper:document.querySelector(".cart__wrapper"),pagination:document.querySelector(".tui-pagination"),cartProducts:document.querySelector(".cart__products"),cartQuantity:document.querySelectorAll(".cart-quantity"),deleteAllProductsFromCart:document.querySelector(".cart__delete-button"),totalPrice:document.querySelector("#cart__total"),sendForm:document.querySelector(".checkout__field")};let A={keyword:null,category:null,page:1,limit:6},g=JSON.stringify(A);const P=document.querySelector(".footer__form");function z(e){return l.cartQuantity.forEach(s=>s.textContent=e.length)}const b="https://food-boutique.b.goit.study/api",d=v.create({baseURL:`${b}/products`}),R=v.create({baseURL:`${b}/subscription`}),Y=v.create({baseURL:`${b}/orders`});function K(e,s){localStorage.setItem(s,JSON.stringify(e))}function I(e){try{const s=localStorage.getItem(e);return s?JSON.parse(s):[]}catch(s){console.log(s.message)}}const n="/BASE_URL/assets/icons-30be3c26.svg";async function x(){const e=I(q.CART_KEY);e&&e.forEach(({_id:s})=>{document.querySelectorAll(`[data-id="${s}"]`).forEach(a=>{const o=a.querySelector(".cards__button");o&&(o.innerHTML=`<svg class="icon-checked"><use href="${n}#icon-check"></use></svg>`)})})}async function Q(){return(await d({method:"GET",url:"/categories"})).data}async function h(){const e=await d({method:"GET"});return x(),e.data}async function W(e,s){const t=await d({method:"GET",url:`?page=${e}&limit=${s}`});return console.log(t.data),t.data}async function $(e,s,t){return(await d({method:"GET",url:`?keyword=${e}&page=${s}&limit=${t}`})).data}async function T(e,s,t,a){return(await d({method:"GET",url:`?keyword=${e}&category=${s}&page=${t}&limit=${a}`})).data}async function O(e,s,t){return(await d({method:"GET",url:`?category=${e}&page=${s}&limit=${t}`})).data}async function V(e){return(await d({method:"GET",url:`/${e}`})).data}async function X(){return(await d({method:"GET",url:"/discount"})).data}async function Z(){return(await d({method:"GET",url:"/popular"})).data}function m(e){return e=e.replace("_&_"," / "),e=e.replace("_"," "),e}function w(e){return e=e.replace(/ /g,"_"),e=e.replace(/\//g,encodeURIComponent("&")),e}function ee(){const e=l.productsFiltersSelect.options[l.productsFiltersSelect.selectedIndex];let s=localStorage.getItem("filter"),t=s?JSON.parse(s):{};const a=e.textContent!=="Show all"?e.textContent:null;t.category=a,localStorage.setItem("filter",JSON.stringify(t)),t.category===null&&t.keyword===null?(localStorage.setItem("filter",g),t.category=null,h().then(o=>{let c=u(o.results);l.productsCards.innerHTML=c}).catch):t.category!==null&&t.keyword===null?O(w(t.category),t.page,t.limit).then(o=>{let c=u(o.results);l.productsCards.innerHTML=c,console.log(o)}).catch(o=>{console.log(o)}):t.category===null&&t.keyword!==null?(localStorage.setItem("filter",JSON.stringify(t)),h().then(o=>{let c=u(o.results);localStorage.setItem("filter",g),l.productsFilters.value="",l.productsCards.innerHTML=c,x()}).catch,localStorage.setItem("filter",data1),l.productsFilters.value=""):t.category!==null&&t.keyword!==null&&T(t.keyword,w(t.category),t.page,t.limit).then(o=>{let c=u(o.results);l.productsCards.innerHTML=c,console.log(o)}).catch(o=>{console.console.log()})}function te(e){e.preventDefault();const s=l.input.value;let t=localStorage.getItem("filter"),a=t?JSON.parse(t):{};const o=s!==""?s:null;a.keyword=o,localStorage.setItem("filter",JSON.stringify(a));let c=g;a.keyword===null?h().then(r=>{let i=u(r.results);localStorage.setItem("filter",c),l.productsCards.innerHTML=i}).catch(r=>{console.error(r)}):a.keyword!==null&&a.category===null?$(a.keyword,a.page,a.limit).then(r=>{let i=u(r.results);l.productsCards.innerHTML=i}).catch(r=>{console.error(r)}):a.keyword!==null&&a.category!==null?T(a.keyword,a.category,a.page,a.limit).then(r=>{let i=u(r.results);l.productsCards.innerHTML=i}).catch(r=>{console.error(r)}):a.keyword!==null&&a.category===null&&(localStorage.setItem("filter",JSON.stringify(a)),$(a.keyword,a.page,a.limit).then(r=>{let i=u(r.results);l.productsCards.innerHTML=i}).catch(r=>{console.error(r)}))}const k="/BASE_URL/assets/empty-mobile-88cc64a6.png",M="/BASE_URL/assets/empty-mobile@2x-9530797e.png",U="/BASE_URL/assets/empty-tab-8d1fa0db.png",F="/BASE_URL/assets/empty-tab@2x-36112229.png",E="/BASE_URL/assets/checkout-image2x-046578b5.png",N="/BASE_URL/assets/checkout-image2x-046578b5.png";function u(e){return e.map(({_id:s,name:t,img:a,category:o,price:c,size:r,popularity:i})=>`
                ...
                </li>`).join("")}function se(e){return e.map(({_id:s,name:t,img:a,category:o,size:c,popularity:r})=>`<li class="cards__item popular__item" data-id="${s}">
            ...
            <p class="cards__title">${t}</p>
                ...
                <svg class="icon__cart">
                 ...
                 </li>`).join("")}function oe({_id:e,name:s,img:t,category:a,price:o,size:c,popularity:r,desc:i}){return`<div class="modal__item cards__item" data-id="${e}">
...
`,{onShow:a=>{window.addEventListener("keydown",t),e=a.element().querySelector(".footer__modal-close"),e.addEventListener("click",()=>a.close()),document.body.classList.add("modal-open")},onClose:()=>{e.removeEventListener("click",()=>s.close()),window.removeEventListener("keydown",t),document.body.classList.remove("modal-open")}});s.show();function t(a){a.code==="Escape"&&s.close()}};P.addEventListener("submit",H);function H(e){e.preventDefault();const{value:s}=e.currentTarget.elements.email;s!==""&&(J(s),e.target.reset())}async function J(e){try{(await R({method:"POST",data:{email:e}})).statusText==="Created"&&S()}catch({response:s}){s.statusText==="Conflict"&&G()}}export{re as a,ce as b,q as c,Y as d,le as e,X as f,I as g,ae as h,x as i,Z as j,se as k,V as l,n as m,oe as n,Q as o,m as p,z as q,l as r,K as s,g as t,h as u,u as v,ee as w,te as x,W as y};
//# sourceMappingURL=subscription-d12063ab.js.map
